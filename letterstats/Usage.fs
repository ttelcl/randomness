...
let usage detail =
  ...
  cpx " [\fg-ml\f0 <\fccount\f0>] [\fg-mb\f0 <\fcbits\f0>] [\fg-xb\f0 <\fcbits\f0>]"
  cp " [\fg-bl\f0 <\fcfile.words.csv\f0>] [\fg-bits\f0] [\fg-k\f0 <\fccount\f0>]"
  ...
  cp "  \fg-bits\f0\fx\fx              Display information content of generated words"
  cp "  \fg-k\f0 <\fccount\f0>         Construct phrases of <\fccount\f0> words (default 1)"
  cp ""
