...
let usage detail =
  ...
  cp ""
  cp "\forandom words\f0 \fg-list\f0 \fclistname\f0 [\fg-bits\f0 \fcentropy\fk=128\f0] [\fg-n\f0 \fccount\fk=1\f0] [\fg-s\f0]"
  ...
  cp "  \fg-s\f0\fx\fx                Use a space as word separator instead of the default '-'"
  cp ""
