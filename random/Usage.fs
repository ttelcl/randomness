...
let usage detail =
  ...
  cp ""
  cp "\forandom guid\f0 [\fg-n\f0 <\fccount\f0>]"
  cp "  Generate a type 4 (random) GUID"
  cp ""
  cp "\forandom hex\f0 [\fg-bytes\f0|\fg-b\f0] <\fcbytes\f0> [\fg-n\f0 <\fccount\f0=1>]"
  cp "\forandom HEX\f0 [\fg-bytes\f0|\fg-b\f0] <\fcbytes\f0> [\fg-n\f0 <\fccount\f0=1>]"
  cp "\forandom base32\f0 [\fg-bytes\f0|\fg-b\f0] <\fcbytes\f0> [\fg-n\f0 <\fccount\f0=1>]"
  cp "\forandom base64\f0 [\fg-bytes\f0|\fg-b\f0] <\fcbytes\f0> [\fg-n\f0 <\fccount\f0=1>]"
