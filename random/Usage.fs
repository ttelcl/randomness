...
let usage detail =
  ...
  cp ""
  cp "\forandom characters\f0 [\fg-alphabet\f0] <\fcalphabet\f0> [\fg-bits\f0 <\fcentropy\f0=\fy128\f0>] [\fg-n\f0 <\fccount\f0=\fy1\f0>]" 
  ...
  cp "  \fg-alphabet\f0 <\fccharacters\f0>  The characters to choose from. You can include ranges using '-'"
